...
// Clear ALL cached wearable reviews — forces fresh evaluation with new recovery-based copy.
// Safe: rows are regenerated automatically on next page load.
try { db.exec("DELETE FROM daily_wearable_reviews"); } catch (_) {}
