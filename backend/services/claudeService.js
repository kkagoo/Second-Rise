...
async function generateRecommendation(profile, checkin, readiness, priorFeedback, availableVideos, biometrics = null, history = [], baseline = null, weeklySchedule = [], checkinTrend = [], biometricTrend = null, recentManualActivities = []) {
  const client = getClient();
  const userPrompt = buildVideoPrompt(profile, checkin, readiness, priorFeedback, availableVideos, biometrics, history, baseline, weeklySchedule, checkinTrend, biometricTrend, recentManualActivities);
